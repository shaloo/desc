...
`Click here to view <../puttshack-apis/index.html>`_ the complete Puttshack Cloud API Reference Guide.

.. note::

     This API Reference Guide is based on API specifications document dated Aug 16, 2021.
